...
const STATIC_TEXTS = {
  ...
  [Languages.BENGALI]: {
    changeConsent: "আপনার সম্মতি পরিবর্তন করুন",
    withdrawConsent: "আপনার সম্মতি প্রত্যাহার করুন",
    consentTab: "সম্মতি",
    aboutTab: "কুকিজ সম্পর্কে",
    managePreferences: "সম্মতি পছন্দগুলি পরিচালনা করুন",
    privacyPolicy: "গোপনীয়তা নীতি",
    whatAreCookies: "কুকিজ কী?",
    cookieName: "কুকির নাম",
    duration: "সময়কাল",
    description: "বর্ণনা",
    aboutCookiesTitle: "কুকিজ কী?",
    aboutCookiesPara1:
      "কুকিজ হল ছোট টেক্সট ফাইল যা ওয়েবসাইটগুলি ব্যবহারকারীর অভিজ্ঞতা আরও দক্ষ করতে ব্যবহার করতে পারে।",
    aboutCookiesPara2:
      "আইনটি বলে যে আমরা আপনার ডিভাইসে কুকিজ সংরক্ষণ করতে পারি যদি এই সাইটটির পরিচালনার জন্য তারা কঠোরভাবে প্রয়োজনীয় হয়। অন্যান্য সমস্ত ধরণের কুকিজের জন্য আমাদের আপনার অনুমতি প্রয়োজন। এই সাইটটি বিভিন্ন ধরণের কুকিজ ব্যবহার করে। কিছু কুকিজ তৃতীয় পক্ষের পরিষেবাগুলি দ্বারা স্থাপন করা হয় যা আমাদের পৃষ্ঠাগুলিতে প্রদর্শিত হয়। আপনি যেকোনো সময় আমাদের ওয়েবসাইটে কুকি ঘোষণা থেকে আপনার সম্মতি পরিবর্তন বা প্রত্যাহার করতে পারেন।",
    aboutCookiesPara3:
      "আমরা কে, কীভাবে আপনি আমাদের সাথে যোগাযোগ করতে পারেন এবং আমরা আমাদের গোপনীয়তা নীতিতে ব্যক্তিগত ডেটা কীভাবে প্রক্রিয়া করি সে সম্পর্কে আরও জানুন।",
    poweredBy: "দ্বারা পরিচালিত",
  },
  [Languages.GUJARATI]: {
    changeConsent: "તમારી સંમતિ બદલો",
    withdrawConsent: "તમારી સંમતિ પાછી ખેંચો",
    consentTab: "સંમતિ",
    aboutTab: "કૂકીઝ વિશે",
    managePreferences: "સંમતિ પસંદગીઓ સંચાલિત કરો",
    privacyPolicy: "ગોપનીયતા નીતિ",
    whatAreCookies: "કૂકીજ શું છે?",
    cookieName: "કૂકીનું નામ",
    duration: "અવધિ",
    description: "વર્ણન",
    aboutCookiesTitle: "કૂકીઝ શું છે?",
    aboutCookiesPara1:
      "કૂકીઝ નાની ટેક્સ્ટ ફાઇલો છે જેનો ઉપયોગ વેબસાઇટ્સ દ્વારા વપરાશકર્તાના અનુભવને વધુ કાર્યક્ષમ બનાવવા માટે થઈ શકે છે.",
    aboutCookiesPara2:
      "કાયદો જણાવે છે કે આ સાઇટના સંચાલન માટે જો તે સખત જરૂરી હોય તો અમે તમારા ઉપકરણ પર કૂકીઝ સંગ્રહિત કરી શકીએ છીએ. અન્ય તમામ પ્રકારની કૂકીઝ માટે અમને તમારી પરવાનગીની જરૂર છે. આ સાઇટ વિવિધ પ્રકારની કૂકીઝનો ઉપયોગ કરે છે. કેટલીક કૂકીઝ અમારા પૃષ્ઠો પર દેખાતી ત્રીજા પક્ષની સેવાઓ દ્વારા મૂકવામાં આવે છે. તમે કોઈપણ સમયે અમારી વેબસાઇટ પર કૂકી ઘોષણામાંથી તમારી સંમતિ બદલી અથવા પાછી ખેંચી શકો છો.",
    aboutCookiesPara3:
      "અમે કોણ છીએ, તમે અમારો કેવી રીતે સંપર્ક કરી શકો છો અને અમે અમારી ગોપનીયતા નીતિમાં વ્યક્તિગત ડેટાની પ્રક્રિયા કેવી રીતે કરીએ છીએ તે વિશે વધુ જાણો.",
    poweredBy: "દ્વારા સંચાલિત",
  },
  [Languages.SANSKRIT]: {
    changeConsent: "भवतः सम्मतिं परिवर्तयन्तु",
    withdrawConsent: "भवतः सम्मतिं प्रत्याहरन्तु",
    consentTab: "सम्मतिः",
    aboutTab: "कुकीषु विषये",
    managePreferences: "सम्मति-प्राधान्यानि प्रबन्धयन्तु",
    privacyPolicy: "गोपनीयता-नीतिः",
    whatAreCookies: "कुकीः किम्?",
    cookieName: "कुकी-नाम",
    duration: "अवधिः",
    description: "वर्णनम्",
    aboutCookiesTitle: "कुकीः किम्?",
    aboutCookiesPara1:
      "कुकीः लघु-पाठ-सञ्चिकाः सन्ति याः उपयोक्तुः अनुभवं अधिकं कार्यक्षमं कर्तुं जालस्थलैः उपयुज्यन्ते।",
    aboutCookiesPara2:
      "विधिः कथयति यत् वयं भवतः यन्त्रे कुकीः संरक्षयितुं शक्नुमः यदि ते अस्य स्थलस्य संचालनाय कठोरतया आवश्यकाः सन्ति। सर्वेषां अन्येषां प्रकाराणां कुकीषां कृते अस्माकं भवतः अनुमतिः आवश्यकी। इदं स्थलं विविध-प्रकाराणां कुकीषां उपयोगं करोति। केचन कुकीः अस्माकं पृष्ठेषु दृश्यमानैः तृतीय-पक्ष-सेवाभिः स्थाप्यन्ते। भवान् कदापि अस्माकं जालस्थले कुकी-घोषणातः स्वस्य सम्मतिं परिवर्तयितुं वा प्रत्याहर्तुं वा शक्नोति।",
    aboutCookiesPara3:
      "वयं के, भवान् अस्मान् कथं सम्पर्कयितुं शक्नोति, अस्माकं गोपनीयता-नीतौ वयं व्यक्तिगत-दत्तांशं कथं संसाधयामः इति विषये अधिकं जानन्तु।",
    poweredBy: "द्वारा संचालितम्",
  },
  [Languages.ODIA]: {
    changeConsent: "ଆପଣଙ୍କ ସମ୍ମତି ପରିବର୍ତ୍ତନ କରନ୍ତୁ",
    withdrawConsent: "ଆପଣଙ୍କ ସମ୍ମତି ପ୍ରତ୍ୟାହାର କରନ୍ତୁ",
    consentTab: "ସମ୍ମତି",
    aboutTab: "କୁକିଜ ବିଷୟରେ",
    managePreferences: "ସମ୍ମତି ପସନ୍ଦଗୁଡ଼ିକ ପରିଚାଳନା କରନ୍ତୁ",
    privacyPolicy: "ଗୋପନୀୟତା ନୀତି",
    whatAreCookies: "କୁକିଜ କଣ?",
    cookieName: "କୁକି ନାମ",
    duration: "ଅବଧି",
    description: "ବର୍ଣ୍ଣନା",
    aboutCookiesTitle: "କୁକିଜ କଣ?",
    aboutCookiesPara1:
      "କୁକିଜ ହେଉଛି ଛୋଟ ପାଠ୍ୟ ଫାଇଲ ଯାହା ୱେବସାଇଟଗୁଡ଼ିକ ଦ୍ୱାରା ଉପଯୋଗକର୍ତ୍ତାଙ୍କ ଅଭିଜ୍ଞତାକୁ ଅଧିକ କାର୍ଯ୍ୟକ୍ଷମ କରିବା ପାଇଁ ବ୍ୟବହାର କରାଯାଇପାରେ।",
    aboutCookiesPara2:
      "ନିୟମ କହେ ଯେ ଯଦି ଏହି ସାଇଟର ପରିଚାଳନା ପାଇଁ ସେଗୁଡ଼ିକ କଠୋରଭାବେ ଆବଶ୍ୟକ ତେବେ ଆମେ ଆପଣଙ୍କ ଉପକରଣରେ କୁକିଜ ସଂରକ୍ଷଣ କରିପାରିବା। ଅନ୍ୟ ସମସ୍ତ ପ୍ରକାରର କୁକିଜ ପାଇଁ ଆମକୁ ଆପଣଙ୍କ ଅନୁମତି ଆବଶ୍ୟକ। ଏହି ସାଇଟ ବିଭିନ୍ନ ପ୍ରକାରର କୁକିଜ ବ୍ୟବହାର କରେ। କିଛି କୁକିଜ ଆମର ପୃଷ୍ଠାରେ ଦେଖାଯାଉଥିବା ତୃତୀୟ ପକ୍ଷ ସେବା ଦ୍ୱାରା ରଖାଯାଏ। ଆପଣ ଯେକୌଣସି ସମୟରେ ଆମର ୱେବସାଇଟରେ କୁକି ଘୋଷଣାରୁ ଆପଣଙ୍କ ସମ୍ମତି ପରିବର୍ତ୍ତନ କିମ୍ବା ପ୍ରତ୍ୟାହାର କରିପାରିବେ।",
    aboutCookiesPara3:
      "ଆମେ କିଏ, ଆପଣ ଆମକୁ କିପରି ଯୋଗାଯୋଗ କରିପାରିବେ ଏବଂ ଆମର ଗୋପନୀୟତା ନୀତିରେ ଆମେ ବ୍ୟକ୍ତିଗତ ତଥ୍ୟକୁ କିପରି ପ୍ରକ୍ରିୟା କରୁ ସେ ବିଷୟରେ ଅଧିକ ଜାଣନ୍ତୁ।",
...
const CookieBanner = () => {
  ...
  useEffect(() => {
    ...
    const handleBeforeUnload = () => {
      if (!localStorage.getItem("browserId") && interactionId) {
        trackIgnoredInteraction();
      }
    };
      ...
      {!isModalOpen && bannerData && !hasSavedPreference && (
        ...
        >
          <div className="p-6 pb-10 relative">
            ...
            >
              <span style={{ color: "black", fontSize: "0.75rem" }}>
                {" "}
                {t.poweredBy}{" "}
              </span>
              <img
